...
// interfaces, mirroring the root module's internal/daggerkit/adapter.go.
package daggerkit
...
// GetRealDirectory returns the underlying real Dagger directory for use with
// shared functions.
...
func (a *DaggerContainerAdapter) WithExec(args []string) DaggerContainer {
	return &DaggerContainerAdapter{container: a.container.WithExec(args)}
}
