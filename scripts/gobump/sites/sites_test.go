...
// TestSitesWellFormed iterates the real production var Sites and asserts
// every entry compiles cleanly — the standing guard against a malformed
// anchor or an unsafe path ever landing in the registry.
